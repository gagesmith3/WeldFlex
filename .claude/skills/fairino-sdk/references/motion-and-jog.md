...
## `StartJOG(self, ref, nb, dir, max_dis, vel=20.0, acc=100.0)` — `Robot.py`
...
and if it's non-zero, returns *that* code instead of
...
## `GetRobotMotionDone(self)` — `Robot.py`
