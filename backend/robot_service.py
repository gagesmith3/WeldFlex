...
class WeldFlexRobotService:
    ...
    def upload_load_run(
        ...
        studs_data_lua = build_studs_data_lua(studs, clearance_z_mm, zerozero_joints=zerozero_joints)
    ...
    def _build_empty_studs_data_lua(self, clearance_z_mm: float, zerozero_joints: list[float] | None) -> str:
        ...
        zerozero_lua = ", ".join(self._format_lua_number(value) for value in joints)
